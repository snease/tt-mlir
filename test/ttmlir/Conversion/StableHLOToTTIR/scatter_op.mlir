...
module @jit_scatter attributes {} {
    func.func public @test_scatter(%arg0: tensor<1x3x320x320xf32>, %arg1: tensor<1x1xi64>, %arg2: tensor<1x3x320x320xf32>) -> tensor<1x3x320x320xf32> {
        // CHECK: [[VAL0:%[0-9]+]] = tensor.empty() : [[TENSOR_SIZE:tensor<[0-9]+x[0-9]+x[0-9]+x[0-9]+xf[0-9]+>]]
        ...
        // CHECK: ([[TENSOR_SIZE]], tensor<1x1xi32>, [[TENSOR_SIZE]], [[TENSOR_SIZE]]) -> tensor<1x3x320x320xf32>
