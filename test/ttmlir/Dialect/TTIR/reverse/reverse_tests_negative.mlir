...
module attributes {} {
  func.func @reverse_non_unique_dims(%arg0: tensor<32x64xf32>) -> tensor<32x64xf32> {
    ...
    %1 = "ttir.reverse"(%arg0, %0) <{dimensions = array<i64: 0, 0>, operand_constraints = [#any_device, #any_device]}> : (tensor<32x64xf32>, tensor<32x64xf32>) -> tensor<32x64xf32>
...
module attributes {} {
  func.func @reverse_out_of_bounds_dim(%arg0: tensor<32x64xf32>) -> tensor<32x64xf32> {
    ...
    %0 = tensor.empty() : tensor<32x64xf32>
    %1 = "ttir.reverse"(%arg0, %0) <{dimensions = array<i64: 2>, operand_constraints = [#any_device, #any_device]}> : (tensor<32x64xf32>, tensor<32x64xf32>) -> tensor<32x64xf32>
    return %1 : tensor<32x64xf32>
  }
}
