...
module attributes {} {
  func.func @forward(%arg0: tensor<1x3x320x320xf32>, %arg1: tensor<1x1xi32>, %arg2: tensor<1x3x320x320xf32>) -> tensor<1x3x320x320xf32> {
    ...
    }) : (tensor<1x3x320x320xf32>, tensor<1x1xi32>, tensor<1x3x320x320xf32>, tensor<1x3x320x320xf32>) -> tensor<1x3x320x320xf32>
    // CHECK: {{[0-9]+}} = "ttnn.scatter"(%2, %4, %6, [[VAL0]]) <{dimension = 0 : i32}> : (tensor<[[TENSOR_SHAPE1]], {{.*}}>, tensor<{{.*}}>, tensor<[[TENSOR_SHAPE1]], {{.*}}>, tensor<[[TENSOR_SHAPE1]], {{.*}}>) -> tensor<[[TENSOR_SHAPE1]], {{.*}}>
